...
class thematiqueController extends Controller
{
   ...
   public function addThematique(Request $Requests)
   {
		...
		$querry=DB::table('thematique')->insertGetId(
	    	['nom' => $nom, 'image_src' => $image_src,'shema' => $schema, 'sous-sous-thematique' => $sous_sous_thematique,'id_instances_gc' => $this->id_instance_gc],'id'
		);
   ...
   public function addSousThematique(Request $Requests)
   {
   	try{
		   	...
		   	$querry=DB::table('sous-thematique')->insertGetId(
					    	['nom' => $nom, 'id-thematique' => $id_thematique],'id'
						);
   		...
   		try{
            ...
            if (!$id_cat) {
            	$querry0 =DB::table('categorie')->insertGetId(
						['type_couche' => $type_couche,'key_couche' => $id,'nom_cat' => $nom,'sous_thematiques' => $sous_thematiques],'id_cat'
					);
            }else{
